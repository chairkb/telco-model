...
import static biz.shujutech.bznes.PersonGotTelephone.TelephoneType;
import biz.shujutech.db.object.Clasz;
import biz.shujutech.base.Connection;
import biz.shujutech.reflect.ReflectField;
import biz.shujutech.db.object.Lookup;

public class PersonGotFax extends GotIntf {
	@ReflectField(type=FieldType.OBJECT, deleteAsMember = false, clasz="biz.shujutech.bznes.TelephoneTypePerson", displayPosition=0, lookup=true) public static String FaxType;
	...
	public Lookup getType() throws Exception {
		TelephoneTypePerson type = (TelephoneTypePerson) this.getFieldObject(FaxType).getValueObj();
		return(type);
	}
