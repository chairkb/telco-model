...
public class Field extends Base implements Comparable {
	...
	public String getValueStr() throws Exception {
		throw new Hinderance("The getValueStr method is not implemented in class: " + this.getMasterClassName() + ", fieid: "+ this.getFieldName());
	}
	...
	public void setValue(Object value) throws Exception {
		throw new Hinderance("The setValue method is not implemented in class: " + this.getMasterClassName() + ", field: "+ this.getFieldName());
	}

	public void setValueStr(String value) throws Exception {
		throw new Hinderance("The setValueStr method is not implemented in class: " + this.getMasterClassName() + ", field: "+ this.getFieldName());
	}

	public Object getValueObj(ObjectBase aDb) throws Exception {
		throw new Hinderance("The getValueObj(ObjectBase) method is not implemented in class: " + this.getMasterClassName() + ", field: "+ this.getFieldName());
	}

	public Object getValueObj(Connection aConn) throws Exception {
		throw new Hinderance("The getValueObj(Connection) method is not implemented in class: " + this.getMasterClassName() + ", field: "+ this.getFieldName());
	}

	public Object getValueObj() throws Exception {
		throw new Hinderance("The getValueObj() method is not implemented in class: " + this.getMasterClassName() + ", field: "+ this.getFieldName());
	}
	...
	public void copyValue(Field aSourceField) throws Exception {
		if (this.getFieldType() == FieldType.STRING || this.getFieldType() == FieldType.HTML) {
			String value = ((FieldStr) aSourceField).getValueStr();
			this.setFieldSize(aSourceField.getFieldSize());
			((FieldStr) this).setValueStr(value);
