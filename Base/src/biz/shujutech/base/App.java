...
public class App {
	...
	public static LogLevel getLogLevel() throws Exception {
		LogLevel result;
		if (AppLogger.getLevel() == Level.SEVERE) {
			result = LogLevel.ERROR; 
		} else if (AppLogger.getLevel() == Level.WARNING) {
			result = LogLevel.WARN; 
		} else if (AppLogger.getLevel() == Level.INFO) {
			result = LogLevel.INFO; 
		} else if (AppLogger.getLevel() == Level.CONFIG) {
			result = LogLevel.COFG; 
		} else if (AppLogger.getLevel() == Level.ALL) {
			result = LogLevel.DEBG; 
		} else if (AppLogger.getLevel() == Level.OFF) {
